...
namespace NSE.MessageBus
{
    public class MessageBus : IMessageBus
    {
        ...
        public void Subscribe<T>(string subscriptionId, Action<T> onMessage) where T : IntegrationEvent
        {
            TryConnect();
            _bus.Subscribe(subscriptionId, onMessage);
        }

        public void SubscribeAsync<T>(string subscriptionId, Func<T, Task> onMessage) where T : IntegrationEvent
        {
            TryConnect();
